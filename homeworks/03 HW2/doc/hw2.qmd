...
The code for each task is a Jupyter notebook in the course repository. Get the latest version from the `main` branch (download the repo as described in HW0), or open a notebook directly:

| Notebook | What you build in it |
|----------|----------------------|
| [`task-1.ipynb`](https://github.com/mathoory/00660121-medical-diagnostics/blob/main/homeworks/03%20HW2/src/task-1/task-1.ipynb) | **Task 1**: a deep neural network from scratch in NumPy. You implement the forward and backward passes of a linear layer, ReLU, and MSE loss, then the training loop. |
| [`task-2.ipynb`](https://github.com/mathoory/00660121-medical-diagnostics/blob/main/homeworks/03%20HW2/src/task-2/task-2.ipynb) | **Task 2**: a PyTorch DNN trained on the gene-expression data and compared against a linear-regression baseline. |
